...
const Projects = () => {
  const sorted = [
    ...
    },
    {
      id: 2,
      header: "Lessons",
      description: "This was my first React Native project and I really enjoyed the experience. I think the best lesson from this build came in the area of UX design. The structured nature of React Native and the incredible open source support meant that there is almost always a component that will do what you need, it's just a matter of properly integrating it into the build.",
      image: "https://i.imgur.com/Qy0Ae4V.png",
    },
    {
      id: 3,
  ...
  const pokematch = [
    ...
    },
    {
      id: 2,
      header: "Lessons",
      description: "This was my first React project and I had a blast building it. One of the biggest hurdles was being able to randomly select 8 Pokemon from 151 before duplicating each one and shuffling them to form the grid. This project helped solidify my understanding of State in React.",
      image: "https://i.imgur.com/ozqwyMd.png",
    },
    {
      id: 3,
